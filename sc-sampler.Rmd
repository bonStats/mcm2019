...
Inverting $\boldsymbol{V}$ (or decomposing) is $\mathcal{O}(p^3)$.
...
**Aim**: Exploit the geometry learned by decomposing the prior to create a better Gibbs sampler.

--

(a1) Sample $(\boldsymbol{\omega}~\vert~\boldsymbol{\beta}, \boldsymbol{\lambda}, \sigma^2, \tau) \sim \text{sExp}(b_1)$
   
   - Use information about current magnitude to infer
