...
- We can fix $\vert J \vert$ by selecting $\epsilon$ adaptively.

- Then the complexity is $\mathcal{O}(p^2)$.
...
```{r sse-table, echo=FALSE, eval=TRUE, fig.align='center'}
...
```{r time-table, echo=FALSE, eval=TRUE, fig.align='center'}
knitr::include_graphics("imgs/table-sse.png")
```
